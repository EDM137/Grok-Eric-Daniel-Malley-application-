...
const Header: React.FC = () => {
  return (
    <header className="p-4 md:p-6 border-b border-gray-800 flex justify-between items-center">
      <div>
        <h1 className="text-2xl md:text-4xl font-bold tracking-wider bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500">
          RADEST ALLY VAULT <span className="text-xl align-top opacity-70">v4.0</span>
        </h1>
        <p className="text-xs text-gray-500 tracking-widest">SOVEREIGN COMMAND CENTER</p>
      </div>

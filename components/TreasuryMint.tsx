...
const TreasuryMint: React.FC = () => {
  ...
  return (
    <WidgetCard title="Sovereign Treasury & CPU Mint" icon={<CpuChipIcon className="w-6 h-6" />}>
      <div className="flex flex-col h-full space-y-4">
        ...
        <div className="border-t border-cyan-900/50 pt-4">
            ...
            <div className="mt-4 grid grid-cols-2 gap-4 text-center">
                 <div className="bg-cyan-900/20 p-2 rounded-md">
                    <p className="text-xs text-gray-400">Temperature</p>
                    <p className="text-xl font-bold text-cyan-300">{cpuStats.temp.toFixed(1)}°C</p>
                </div>
                 <div className="bg-cyan-900/20 p-2 rounded-md">
                    <p className="text-xs text-gray-400">Clock Speed</p>
                    <p className="text-xl font-bold text-cyan-300">{cpuStats.clock.toFixed(2)} GHz</p>
                </div>
            </div>
        </div>
      </div>

...
const SecureMedApp: React.FC = () => {
  return (
    <WidgetCard title="Secure Med App" icon={<HeartIcon className="w-6 h-6" />}>
      <div className="space-y-4">
        ...
        <div>
            ...
            <div className="p-3 bg-cyan-900/20 rounded-md flex items-center justify-between">
         ...
         <div>
            ...
            <button className="w-full bg-cyan-900/50 border border-cyan-700 hover:bg-cyan-800/50 transition-colors duration-300 text-cyan-300 font-bold py-3 px-4 rounded-md flex items-center justify-center space-x-2">
